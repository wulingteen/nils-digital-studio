...
*   **🟦 LinkedIn (專業社群)**
    ...
    *   **結構**：切入痛點、給出專業見解或方法論、CTA 號召專業人士討論。不需要太多 Emoji，但要注意分段留白。
*   **🐦 X / Twitter (短打社群)**
    *   **Tone of voice**：簡潔、有力、快節奏、帶點主觀的辛辣或趣味。
    *   **結構**：字數必須在 280 字以內，第一句話就要吸引眼球，附上精練的一句話總結文章核心，適合使用一兩個關鍵 Hashtag。如果是深度的文章，可以提議將文案做成「Thread (推文串)」。
*   **🟦 Facebook (大眾社群 / 粉絲專頁)**
    *   **Tone of voice**：親切、說故事感、多互動、帶有生活感。
    *   **結構**：可以長文，多講兩句撰寫這篇文章時的「心路歷程」或「為什麼想寫」的背景，搭配豐富的 Emoji 降低距離感。
