...
export const titleEn: Record<string, string> = {
    "ai-pm-daily-work": "What Does an AI PM at a Bank Actually Do?",
    "ai-pm-feature-to-patent": "From Feature to Patent: Shipping GenAI in a Regulated Bank",
    "ai-pm-banking-10x-harder": "Why Deploying LLMs in Banking Is 10x Harder Than You Think",
    "ai-pm-vs-traditional-pm": "AI PM vs Traditional PM: A Complete Skill Tree Breakdown",
    "rag-system-design-banking": "RAG System Design: 3 Key Decisions for Financial Knowledge Bases",
    "enterprise-prompt-engineering": "Prompt Engineering Patterns for Enterprise Scenarios",
    "genai-roi-metrics": "How to Measure GenAI ROI? The 4 Metrics I Use",
    "ai-agent-product-design-traps": "5 Product Design Traps When Building AI Agents",
    ...
    "ai-browser-auto-report": "AI Browser: Automatically Recording Reasoning Trails & Generating Investigation Reports",
    "ai-history-hinton-nobel": "AI's Historical Turning Point: From Skepticism to the Nobel Prize",
    "perplexity-challenges": "Perplexity's Dilemma: Where Does AI Search Draw the Line?",
    "google-gemini-antigravity-devops": "Google Gemini 3 Pro & Antigravity: Leveling Up the Developer Role",
    "devfest-taipei-2025-announcement": "DevFest Taipei 2025 Talk Preview: AI Agent Teams in Production",
    "graphrag-smart-customer-service": "GraphRAG: Reshaping Smart Customer Service with Knowledge Graph Reasoning",
    "six-patents-approved-2025": "Six Patents Approved This Year: The Year GenAI Hits the Ground Running",
    "devfest-taipei-signup": "DevFest Taipei 2025 Registration Now Open",
    "best-attention-explanation": "The Best 'Attention Is All You Need' Explanation I've Found",
    "jason-wei-ai-scenarios": "Jason Wei's Talk: A Systematic Method for Finding AI Use Cases",
    "thinking-machine-lab-deterministic-ai": "Mira Murati's Thinking Machine Lab: A Breakthrough in Deterministic AI Reasoning",
    "vibe-coding-three-giants": "The Vibe Coding Big Three: Codex, Gemini & Claude",
    "gemini-flash-nano-banana": "Nano Banana: Testing Gemini 2.5 Flash's Image Generation",
    "hiring-devops-fullstack-ddt": "Nils Is Looking for Teammates! DevOps & Full-Stack Engineers Wanted",
    "ai-pm-peter-deng-uber": "The AI PM Mindset: Peter Deng's Management Philosophy at Uber",
    "chatgpt-agent-launch": "ChatGPT Launches Agents: Like Watching a Secretary Work Your Computer",
...
export const excerptEn: Record<string, string> = {
    "ai-pm-daily-work": "No coding, no model tuning — so what does an AI Product Manager actually do all day? A real daily breakdown from a GenAI PM working in banking.",
    "ai-pm-feature-to-patent": "What does a GenAI feature go through from inception to launch to patent filing? A complete journey record from a bank AI PM.",
    "ai-pm-banking-10x-harder": "Deploying AI in a bank isn't just picking a model. Compliance, security, data governance, organizational culture — each hurdle is harder than the last.",
    "ai-pm-vs-traditional-pm": "Does an AI PM need to code? Need to understand math? A complete skill tree breakdown comparing AI PMs and traditional PMs.",
    "rag-system-design-banking": "Building a RAG system in banking: how to choose your chunk strategy, embedding model, and retrieval pipeline. Lessons from real production experience.",
    "enterprise-prompt-engineering": "Enterprise prompt engineering is nothing like personal ChatGPT use. Structured templates, version control, multi-role design — lessons from the trenches.",
    "genai-roi-metrics": "When your boss asks 'Is AI worth the investment?', you need numbers. Here's the four-metric framework I use to prove GenAI value.",
    "ai-agent-product-design-traps": "AI Agents sound cool, but building Agent products in enterprise is full of pitfalls. Here are five design traps I've experienced firsthand.",
    ...
    "ai-browser-auto-report": "I built an AI Browser that records every reasoning step, tracks queries, auto-decides when to screenshot, and compiles everything into a structured investigation report.",
    "ai-history-hinton-nobel": "There was a time when saying 'AI' in serious academic circles was a mark against you. Geoffrey Hinton won the Turing Award in 2018 and the Nobel Prize in Physics in 2024.",
    "perplexity-challenges": "Perplexity is caught between being the next-generation search paradigm and facing mounting legal pressure from content publishers. Can they find a deal structure that's fair to everyone?",
    "google-gemini-antigravity-devops": "After Google pushed Gemini 3 Pro and Antigravity, I started rethinking the relationship between developers and AI infrastructure — and what 'role elevation' really means.",
    "devfest-taipei-2025-announcement": "On November 30th I'll be presenting real AI Agent team applications running in production at DevFest Taipei 2025, hosted by Google GDG.",
    "graphrag-smart-customer-service": "GraphRAG replaces flat vector retrieval with graph-structured knowledge, enabling multi-hop reasoning and consistent context — 86% accuracy on RobustQA vs. 33–76% for traditional RAG.",
    "six-patents-approved-2025": "All six utility model patents filed at the start of this year have been approved — two dual-filed. Another five submitted last month. This is what real GenAI deployment looks like.",
    "devfest-taipei-signup": "I'll be speaking at DevFest Taipei 2025 on November 30th — AI Agent team applications in production. Free entry, registration required.",
    "best-attention-explanation": "The clearest explanation of 'Attention Is All You Need' I've come across — the mechanics, not just the intuition.",
    "jason-wei-ai-scenarios": "Jason Wei's talk gave me a genuine 'aha' moment. The systematic framework he lays out for finding AI use cases is exactly what I wish I'd articulated earlier.",
    "thinking-machine-lab-deterministic-ai": "Does setting temperature to 0 give perfectly consistent AI outputs? No — and Thinking Machine Lab found out why. Batch processing is the culprit, and they built a fix.",
    "vibe-coding-three-giants": "The vibe coding landscape has consolidated around three players — OpenAI's Codex, Google's Gemini, and Anthropic's Claude. Each pulls in a different direction.",
    "gemini-flash-nano-banana": "Tested Gemini 2.5 Flash's image editing with three sequential prompts — suit, smile, tie adjustment. The precision was genuinely impressive.",
    "hiring-devops-fullstack-ddt": "We're taking financial AI to Southeast Asia and looking for two engineers. DevOps and full-stack roles open in Taipei Xinyi.",
    "ai-pm-peter-deng-uber": "Peter Deng built five PM archetypes at Uber and made their tensions transparent. A great team is like the Avengers — everyone's different, everyone has strong views.",
    "chatgpt-agent-launch": "ChatGPT's agent renders its operations in real-time with full verbosity — like watching a capable human assistant work at a workstation on your behalf.",
