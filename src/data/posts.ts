...
*如果你正在考慮轉職 AI PM，歡迎繼續閱讀這個系列的其他文章。*`
    ...
    {
        id: "ai-pm-feature-to-patent",
        tags: ["AI PM 系列", "GenAI", "Patent"],
        title: "從需求到專利：一個 GenAI 功能的完整生命週期",
        excerpt: "一個 GenAI 功能從發想到上線到申請專利，中間經歷了什麼？銀行 AI PM 的完整旅程紀錄。",
        date: "2026-03-02",
        author: "Nils Liu",
        content: `大多數人看到專利，會覺得那是「研發部門」的事。但在我們團隊，專利是從**產品需求**長出來的。
...
*這是「AI PM 的真實工作」系列的第二篇。*`
    ...
    {
        id: "ai-pm-banking-10x-harder",
        tags: ["AI PM 系列", "GenAI", "Architecture"],
        title: "為什麼金融業 AI 落地比你想的難 10 倍",
        excerpt: "在銀行做 AI 不是選個模型就好。法遵、資安、資料治理、組織文化——每一關都比上一關難打。",
        date: "2026-03-03",
        author: "Nils Liu",
        content: `在新創公司做 AI 產品，你可能三天就能上線一個 chatbot。
...
*這是「AI PM 的真實工作」系列的最終篇。*`
    ...
    {
        id: "rag-system-design-banking",
        tags: ["GenAI 實戰", "GenAI", "Architecture"],
        title: "RAG 系統設計：金融知識庫的 3 個關鍵決策",
        excerpt: "在銀行建 RAG 系統，chunk 策略、embedding 模型、retrieval pipeline 三個決策點怎麼選？實戰經驗分享。",
        date: "2026-03-05",
        author: "Nils Liu",
        content: `RAG（Retrieval-Augmented Generation）是 2024-2025 最熱門的企業 AI 架構。但真正在企業環境中建過 RAG 系統的人都知道：**魔鬼在細節裡。**
...
*這是「GenAI 產品實戰筆記」系列的第三篇。*`
    ...
    {
        id: "ai-agent-product-design-traps",
        tags: ["GenAI 實戰", "Agent", "Architecture"],
        title: "AI Agent 產品設計的 5 個陷阱",
        excerpt: "Agent 聽起來很酷，但在企業環境做 Agent 產品很容易踩坑。這是我親身經歷的五個設計陷阱。",
        date: "2026-03-08",
        author: "Nils Liu",
        content: `2025 年是 AI Agent 元年。到了 2026 年，每個企業都在問：「我們也要做 Agent 嗎？」
